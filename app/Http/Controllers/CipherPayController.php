...
-----END PUBLIC KEY-----';       //header key
    ...
    public function StatusEnquiry(Request $request)
    {
        ...
        $actualReturnUrl = $secondLastSegment === 'self-apply' ? 'https://quikborrow.com/self-apply/premium-offer-response' : 'https://quikborrow.com/loan-agent/ultra-saver-offer-response';

        $redirectUrl = $paymentMessage === 'Transaction Successfull' ? $actualReturnUrl : 'https://quikborrow.com/cipher-payment-failed/';
