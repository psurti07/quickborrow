...
@section('content')
<section id="contacts"
    class="bg--white-100 bg--fixed hero-section pt-100 pb-80 division min-vh-100 d-flex align-items-center">
    <div class="container">
        <div class="row mb-35">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <a href="{{ route('loan.agent.offer2') }}"
                                class="btn btn-xs r-06 btn--theme hover--tra-black px-3 py-3">Try another payment
                                method</a>
