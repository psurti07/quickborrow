...
class HomeController extends Controller
{
    ...
    public function storeCareer(Request $request){
        ...
        if($result){
           try {
                $maildata = array(
                    'fullname' => "QuikBorrow HR",
                    'email' => "info@quikborrow.com"
                );
                $maildata2 = array(
                ...
                $subject2 = 'Welcome to QuikBorrow';
    ...
    public function testdata(){
       ...
       $mailData = array(
        ...
        /* send email in brevo */
        $res = sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for QuikBorrow’s Self-Apply Plan.', $sendGreetings, 3, $attachments);
