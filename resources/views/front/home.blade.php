        ...
        <div class="row d-flex align-items-center">
            <div class="col-md-6 col-lg-6 col-12 ">
                <div class="hero-7-img d-flex justify-content-center align-items-start">
                    <img src="{{ asset('front/images/home-image.png') }}" alt="quikborrow" class="img-fluid p-0">
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-12">
                <div class="hero-7-txt">
                    <div class=" mt-lg-0 mb-lg-5">
                        <h1 class="s-40 w-700">Expert-Led Guidance For <span class="color--green-500">Smarter Financial Decisions</span></h1>
                        <p class="mb-20">We help you move closer to your dreams with premier financial consultation and services from some of the industry’s brilliant minds. </p>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="txt-block right-column bg-white p-4 r-12">
                    <p class="">QuikBorrow is designed for those who value time and clarity. We offer trusted financial solutions that make it easy for you to move forward without unnecessary delay. With our network of reputable NBFC partners, you'll always have access to a diverse range of financial services.</p>
                    <p class="">We keep things simple so you can focus on what matters. From understanding your requirements to helping you move forward, the process is smooth and straightforward. You get the support you need without the usual back and forth or confusion.</p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <div class="txt-block right-column bg--green-400 p-4 r-12 text-white h-100">
                    <p class="">At QuikBorrow, it is about making financial decisions feel easier and more in control. Whether it is something planned or urgent, you can rely on a faster, more comfortable way to access the right solutions and move ahead with confidence.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-2 r-12 border">
                        ...
                        <div class="fbox-txt">
                            ...
                            <p>Make your financial journey easier with the guidance of our experienced professionals.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
...
<section id="products" class="py-80 features-section division">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-10">
                <div class="section-title mb-40">
                    <h2 class="s-28 mb-5">Move Towards Your <span class="color--green-500">Financial Goals Smartly</span>
                    </h2>
                ...
                <div
                    ...
                    <div class="col-12 col-lg-12 bg--green-100 p-4">
                        <div class="txt-block right-column">
                            ...
                            <p class="mb-2">
                                Get quick access to a seamless online process, simple login links, and customized offers from our reliable NBFC partners.
                            </p>
                ...
                <div
                    ...
                    <div class="col-12 col-lg-12 bg--green-100 p-4">
                        <div class="txt-block left-column">
                            ...
                            <p class="mb-2">
                               Allow our experienced professionals to handle the process for you, so you can move forward with ease and without hassle.
                            </p>
            ...
            <div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-2">
                <div class="col">
                    <div class="fbox-11 fbox--hover fb-1 r-12 h-100 w-100 bg-white px-4 py-3 fbox-8 fbox--hover">
                        <div class="fbox-ico ico-40 mb-md-0 mb-3">
                            <div class="shape-ico color--theme">
                                <span class="flaticon-mobile-search"></span>
                            </div>
                        </div>
                        <div class="fbox-txt text-start ms-4">
                            <p class="mt-0">Begin your process by entering your registered mobile number, full name, and other required information.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fbox-11 fbox--hover fb-1 r-12 h-100 w-100 bg-white px-4 py-3 fbox-8 fbox--hover">
                        ...
                        <div class="fbox-txt text-start ms-4">
                            <p class="mt-0">Our system will determine your eligibility and display pre-approved offer(s). This is not a final offer. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fbox-11 fbox--hover fb-1 r-12 h-100 w-100 bg-white px-4 py-3 fbox-8 fbox--hover">
                        ...
                        <div class="fbox-txt text-start ms-4">
                            <p class="mt-0">Purchase the plan that best fits your requirements to access the displayed pre-approved offer(s) </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fbox-11 fbox--hover fb-1 r-12 h-100 w-100 bg-white px-4 py-3 fbox-8 fbox--hover">
                        ...
                        <div class="fbox-txt text-start ms-4">
                            <p class="mt-0">Our team will contact you within 24-48 hours for verification and guide you through the next steps.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fbox-11 fbox--hover fb-1 r-12 h-100 w-100 bg-white px-4 py-3 fbox-8 fbox--hover">
                        ...
                        <div class="fbox-txt text-start ms-4">
                            <p class="mt-0">The NBFC will review your profile and documents in accordance with their policies and guidelines.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="fbox-11 fbox--hover fb-1 r-12 h-100 w-100 bg-white px-4 py-3 fbox-8 fbox--hover">
                        ...
                        <div class="fbox-txt text-start ms-4">
                            <p class="mt-0">The NBFC will process the final approval, sanction, and disbursement in accordance with their terms. </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-12">
                <div class="section-title mb-40">
                    ...
                    <p class="description mt-0 s-16 color--grey">Send us a message, and our team will contact you shortly.</p>
                </div>
            </div>
        </div>
        <div class="row">
