...
-----END PUBLIC KEY-----';       //header key
    ...
    public function sendOtp(Request $request)
    {
        try {
            ...
            if (Cookie::has('user_mobile') && Cookie::get('user_mobile') != $inputs['mobile']) {
                $keysToKeep = ['XSRF-TOKEN', 'quikborrow_session', 'utm_campaign', 'utm_medium', 'utm_source'];
    ...
    public function buyNow()
    {
        ...
        $pdfUrl = 'https://quikborrow.com/application-pdf/'.$encUserId;
        ...
        try {
            ...
            if ($checksum == $recd_checksum) {
                ...
                if ($responseCode == 100 || $responseCode == 208 || /* $responseCode == 102 || */ $responseCode == 601) {
                    ...
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for QuikBorrow Self-Apply Plan.', $sendGreetings, 3, $pdf);
                    if ($response2 > 0) {
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if(Cookie::has('utm_source') && Cookie::get('utm_source') == 'facebook'){
                    ...
                    $fbdata = array(
    						...
    						'sourceurl' => 'https://quikborrow.com/self-apply/paymentSuccess'
    					);
    				if ($fbleads->fbclid != "") {
    ...
    public function getOffer1(Request $request)
    {
        try{
            ...
            $returnUrl = 'https://quikborrow.com/api/self-apply/prime-offer-response';
    ...
    public function getOffer2(Request $request)
    {
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://quikborrow.com/api/self-apply/mega-offer-response';
    ...
    public function getOffer3(Request $request)
    {
        try{
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://quikborrow.com/api/self-apply/premium-offer-response';
            ...
            $request = array(
                ...
                "parameter" => [
                    ...
                    'receiver_vpa' => "cpy.quikborrow@finobank",
    ...
    public function getOffer4(Request $request)
    {
        try{
           ...
           // Log::info('products - '.json_encode($products));
            ...
            $returnUrl = 'https://quikborrow.com/api/self-apply/star-offer-response';
    ...
    public function getOffer5(Request $request)
    {
        try{
            ...
            $returnUrl = 'https://quikborrow.com/airpay-response';
    ...
    public function getOffer7(Request $request){
        try{
            ...
            $redirect_url = 'https://quikborrow.com/api/self-apply/offer-7-response';         // Required - http://, https://, http://www, https://www
