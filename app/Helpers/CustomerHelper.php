		    ...
		    try {
                ...
                try {
                    ...
                    $remote_data = array(
						...
						'product_code' => (($accType == 1) ? 'SELFAPPLY' : (($accType == 2) ? 'HIRELOAN' : 'SELFAPPLY' )),
                ...
                try
                {
                    ...
                    $subject = (($accType == 2)
                        ? 'Congratulations! Payment for QuikBorrow’s Hire Agent plan has been successful.'
                        : (($accType == 3) 
                        ? 'Congratulations! Payment for QuikBorrow’s Self-Apply plan has been successful.'
                        : 'Congratulations! Payment Successful for QuikBorrow’s Self-Apply Plan.'));
